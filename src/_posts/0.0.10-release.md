...
A-Frame is new. The 0.1 version has several known issues, and the API will change over the next few months as we get feedback and open source contributions. Our hope is that early adopters find it as fun as we do, and join us in improving A-Frame over time.
...
Special thanks to the A-Frame team for several months of hard work getting 0.1 out the door:
